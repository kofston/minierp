...
{
    public $column_search = array('offer.order_id','offer.name','offer.c_date','offer.e_date');
    public $column_order = array('offer.order_id','offer.name','offer.c_date','offer.e_date');
